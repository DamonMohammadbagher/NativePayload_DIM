...
#### Usage step-by-step:
      ...
      Step5: make raw payload.bin in cobaltstrike v4.0 host and both files in step3 and step5 should be in same folder & share them via webserver you can use "Python2 -m SimpleHTTPServer" in kali linux
